...
$extensionName = 'Node_Microsoft.Insights.VMDiagnosticsSettings'
$extension = ConvertFrom-Json "$(get-content "C:\Projects\Azure\ServiceFabric\IoTDemo\Diagnostics\PaoloVMDiagnosticsSettings.json")"
